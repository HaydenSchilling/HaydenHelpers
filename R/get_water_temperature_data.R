#' Download WaterNSW Gauge Temperature Data
#'
#'@description
#'This function pulls water temperature data from the NSW Water Online API. https://api-portal.waternsw.com.au/reports.
...
#'
#' @returns Dataframe containing daily temperature data
#' @export
#'
#'
#' @examples
...
#' sites <- c("418026","425012","425003")
#' date_start <- "01-Jan-2022 00:00"
#' date_end <- "01-Jan-2024 00:00"
#'
#' #NOT RUN
#' # water_data <- get_water_temperature_data(sites = sites,
#' # date_start = date_start, temperature_end = date_end, token = water_token)



get_water_temperature_data <- function(sites, date_start, date_end, token) {
  ...
  request_url <- paste0(
    ...
    sites_fixed,
    "&frequency=Daily&dataType=Combined&variable=WaterTemperature&startDate=",
    date_start_fixed,
    "&endDate=",
    date_end_fixed,
    "&pageNumber=1"
